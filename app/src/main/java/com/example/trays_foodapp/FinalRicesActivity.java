...
public class FinalRicesActivity extends AppCompatActivity implements RecyclerFoodsFinalAdapter.OnItemClickFinalListner {

    private RecyclerView recyclerView3;
    private DatabaseReference reference;
    private DatabaseReference mDatabaseRef;

    private Context mContext = FinalRicesActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_final_rices);

        recyclerView3 = (RecyclerView) findViewById(R.id.recyclerViewRices);
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren())
                {
                    ...
                    recyclerAdapterFinal.setOnItemClickFinalListner(FinalRicesActivity.this); // add finally
