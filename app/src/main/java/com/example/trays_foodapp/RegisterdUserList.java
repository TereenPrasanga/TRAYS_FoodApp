...
public class RegisterdUserList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Myadapter adapter =new  Myadapter(this,muname,memail,mtelephone);
    ...
    class Myadapter extends ArrayAdapter<String>
    {
        ...
        Myadapter(Context c ,String uname[],String emial[],String telephone[])
        {
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            Button delete = row.findViewById(R.id.userlistdeleteBtnID);
