...
public class FinalKottuActivity extends AppCompatActivity implements RecyclerFoodsFinalAdapter.OnItemClickFinalListner{

    private RecyclerView recyclerView3;
    private DatabaseReference reference;
    private DatabaseReference mDatabaseRef;

    private Context mContext = FinalKottuActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_final_kottu);

        recyclerView3 = (RecyclerView) findViewById(R.id.recyclerViewKottu);
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren())
                {
                    ...
                    recyclerAdapterFinal.setOnItemClickFinalListner(FinalKottuActivity.this); // add finally
