...
public class FinalFoodsActivity extends AppCompatActivity implements RecyclerFoodsFinalAdapter.OnItemClickFinalListner {
    private RecyclerView recyclerView3;
    private DatabaseReference reference;
    private DatabaseReference mDatabaseRef;

    private Context mContext = FinalFoodsActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_final_foods);
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren())
                {
                    ...
                    recyclerAdapterFinal.setOnItemClickFinalListner(FinalFoodsActivity.this); // add finally
